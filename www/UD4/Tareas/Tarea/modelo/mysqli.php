...
function createTablaUsuarios()
{
    try {
        ...
        else
        {
            ...
            $sql = 'CREATE TABLE `usuarios` (`id` INT NOT NULL AUTO_INCREMENT , `username` VARCHAR(50) NOT NULL , `nombre` VARCHAR(50) NOT NULL , `apellidos` VARCHAR(100) NOT NULL , `contrasena` VARCHAR(100) NOT NULL ,`rol` TINYINT(1) NOT NULL DEFAULT 0,  PRIMARY KEY (`id`)) ';
            if ($conexion->query($sql))
            {
