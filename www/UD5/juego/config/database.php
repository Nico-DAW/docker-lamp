...
class Conexion{
    ...
    */
    ...
    /* 
    Los métodos que vayamos a llamar desde fuera de la clase los declaramos public 
    y con los que vayamos a realizar operaciones internas en la clase private.
    */
